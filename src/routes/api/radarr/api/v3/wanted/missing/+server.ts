...
import { buildWantedMissing } from '$lib/server/arr/wanted.js';

/** GET /api/radarr/api/v3/wanted/missing */
export const GET: RequestHandler = async (event) => {
	...
	return json(await buildWantedMissing('Radarr', { page, pageSize, sortKey, sortDirection }));
};
